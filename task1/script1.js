...
// const names = arr2.map((item) => console.log (item))

// // 4.Console only names which is Anar
// const result = arr2.filter(arr2 => arr2 == 'Anar')
// console.log(result)
...
// const sum = arr4.reduce((acc, number) => acc + number, 0)
// console.log(sum)
...
// const result = arr.findIndex(arr => arr == 5)
// console.log(result)
// const result2 = arr.findLastIndex(arr => arr == 5)
// console.log(result2)
...
// const result = arr.findIndex(arr => arr == 7)
// const result1 = arr.findLastIndex(arr => arr == 7)
